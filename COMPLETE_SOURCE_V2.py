# ============================================================
# ESTHER TRADING BOT v2 — COMPLETE SOURCE CODE
# 32,259 lines | 31 modules | 137 tests | 5 agents
# Generated: Sun Mar 29 20:42:34 EDT 2026
# ============================================================
...
class AlpacaClient:
    ...
    async def get_quote(self, symbol: str) -> AlpacaQuote:
        ...
        data = await self._request(
            "GET", f"{self.data_url}/stocks/{symbol}/snapshot"
        )
        assert isinstance(data, dict)
...
# ================================================================
# FILE: esther/signals/premarket.py
#      891 lines
# ================================================================
...
risk:
  max_positions:
    ...
    tier2: 3
    tier3: 3
  daily_loss_cap_pct: 0.02    # 2% kill-switch (sovereign instruction set)
...
sizing:
  ...
  min_contracts: 10            # minimum 10 contracts (was 1) — $1K+ per trade
  max_contracts: 100           # scale to 100 contracts as account grows
  win_streak_multiplier: 1.20  # increase by 20% after each win (aggressive compound)
  loss_streak_divisor: 1.25    # decrease by 20% after each loss (protect capital)
...
engine:
  ...
  eod_cleanup: "15:45"
  first_trade_after: "10:00"   # NO trades before 10 AM (skip FOMO zone)
  max_trades_per_day: 2        # max 1-2 trades per day
